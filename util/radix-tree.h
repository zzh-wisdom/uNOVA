...
#define RADIX_TRE_MAX_PATH (DIV_ROUND_UP(RADIX_TREE_INDEX_BITS, RADIX_TREE_MAP_SHIFT))
...
static inline unsigned int iter_shift(const struct radix_tree_iter *iter) { return 0; }
...
static inline int radix_tree_insert(struct radix_tree_root *root, unsigned long index,
                                    void *entry) {
...
static inline void **__radix_tree_next_slot(void **slot, struct radix_tree_iter *iter,
                                            unsigned flags) {
    return slot;
}
 ...
 */
static inline void **radix_tree_next_slot(void **slot, struct radix_tree_iter *iter,
                                          unsigned flags) {
